...
public interface Json extends Iterable<Json>, Cloneable{
	...
	public static JsonPointer instance = new JsonPointer();
	...
	public static Json of(InputStream input) throws JsonParseException{ 
		JsonProvider provider = getInstance();
		return provider.of(input);
	}
	public static Json of(String string) throws JsonParseException{ 
		JsonProvider provider = getInstance();
		return provider.of(string);
	}
	public static Json ofStringJson(String json) throws JsonParseException{ 
		JsonProvider provider = getInstance();
		return provider.ofStringJson(json);
	}
	public static Json ofObject() {
		JsonProvider provider = getInstance();
		return provider.ofObject();
	}
	public static Json ofArray() {
		JsonProvider provider = getInstance();
		return provider.ofArray();
	}
	
	public static final byte STRING = 1, NUMBER = 2, BOOLEAN = 3, ARRAY = 4, OBJECT = 5, NULL = 0;
	public byte getType();
	public byte getType(String key) throws JsonNoSuchPropertyException, JsonNoParentException;
	public byte getType(int key) throws JsonNoSuchPropertyException;
	...
	// public JsonEntry getInnerRepresentation();
	// put(key, value)
