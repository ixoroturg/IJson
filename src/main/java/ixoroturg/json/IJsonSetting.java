...
public class IJsonSetting {
   ...
   * Default: 8
   */
  static int PARSE_CONTEXT_COUNT = 8;
   ...
   * Default: 8
   */
  static int FORMAT_CONTEXT_COUNT = 8;
  /**
  ...
  */
  ...
  public static void setParsePoolSetting(int initialCount, int maxCount, float scaleFactor){
	  IJsonParseContext.generatePool(initialCount, maxCount, scaleFactor);
  }
  public static void setFormatPoolSetting(int initialCount, int maxCount, float scaleFactor){
	  IJsonFormatContext.generatePool(initialCount, maxCount, scaleFactor);
  }
  /**
